...
public class Address implements Serializable {
    ...
    private Boolean isDefault;//布尔类型一般对应整数字段，0为假，非0为真
    //有些命名规则java 对象中以 "is" 开头的布尔类型属性会被映射到数据库表中去掉 "is" 开头部分后的字段
    // 这个时候最好还是加上指定的字段名（防止对应错了）
     ...
     * 逻辑删除
     */
    private Boolean deleted;//并不是只有is开头才能注入布尔类型的属性，跟这基本没啥关系，不用过多注意！
