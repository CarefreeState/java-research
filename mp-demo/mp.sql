...
CREATE TABLE IF NOT EXISTS `address` (
    ...
    `street` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '详细地址',
    `contact` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '联系人',
    `is_default` TINYINT(1) DEFAULT b'0' COMMENT '是否是默认 1默认 0否',
    `notes` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
    `deleted` TINYINT(1) DEFAULT b'0' COMMENT '逻辑删除',
    PRIMARY KEY (`id`) USING BTREE,
    KEY `user_id` (`user_id`) USING BTREE
    ) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=COMPACT;

INSERT INTO `address` (`id`, `user_id`, `province`, `city`, `town`, `mobile`, `street`, `contact`, `is_default`, `notes`, `deleted`) VALUES
    (59, 2, '北京', '北京', '朝阳区', '13900112222', '金燕龙办公楼', 'Rose', 1, NULL, 0),
    (60, 1, '北京', '北京', '朝阳区', '13700221122', '修正大厦', 'Jack', 0, NULL, 0),
    (61, 1, '上海', '上海', '浦东新区', '13301212233', '航头镇航头路', 'Jack',1, NULL, 0),
    (63, 2, '广东', '佛山', '永春', '13301212233', '永春武馆', 'Rose', 1, NULL, 0),
    (64, 3, '浙江', '杭州', '拱墅区', '13567809102', '浙江大学', 'Hope', 1, NULL, 0),
    (65, 3, '浙江', '杭州', '拱墅区', '13967589201', '左岸花园', 'Hope', 0, NULL, 0),
    (66, 4, '湖北', '武汉', '汉口', '13967519202', '天天花园', 'Thomas', 1, NULL, 0),
    (67, 3, '浙江', '杭州', '拱墅区', '13967589201', '左岸花园', 'Hopey', 0, NULL, 0),
    (68, 4, '湖北', '武汉', '汉口', '13967519202', '天天花园', 'Thomas', 1, NULL, 0),
    (69, 3, '浙江', '杭州', '拱墅区', '13967589201', '左岸花园', 'Hopey', 0, NULL, 0),
    (70, 4, '湖北', '武汉', '汉口', '13967519202', '天天花园', 'Thomas', 1, NULL, 0);
-- 导出  表 mp.user 结构
CREATE TABLE `user` (
